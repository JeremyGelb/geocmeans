...
To confirm ths observation, we can do a spatial diagnostic with the function *spatialdiag* of the geocmeans package. We will compare the results of the classical and the spatial solutions. We can compare the final results too with the k-means solution with a little bit more work.
...
* adding support for categorical variables (gower distancem and AFDM)
