...
#' obvservations i and j. Its is recommanded to use a matrix standardized by row
...
#' A parameter alpha allow to control for the weight of the lagged matrice. If
