...
```
So on average, for this classification, the spatial inconsistency index is arround 0.18.

## Adjusted spatial inconsistency index

The spatial inconsistency index presented above has two draw backs : 

* first, as the number of cluster increases, the index will increase too because more borders will be needed to delimitate them in space.
