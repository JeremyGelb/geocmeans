...
@cai2007fast described in their article the method, originally applied in the analysis of brain imagery. The generalized version of the spatial fuzzy c-means is presented by @zhao2013kernel.

@gelb2021apport applied the method to socio-residential and environmental data and compared the results with oter unsupervised classification algorithms (in french).
